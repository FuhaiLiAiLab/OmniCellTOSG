...
def parse_command_line_overrides() -> Dict[str, Any]:
    ...
    parser.add_argument('--task', type=str, help='Downstream task type')
    ...
    parser.add_argument('--stratified_balancing', type=lambda x: x.lower() == 'true', help='Whether to balance dataset')
    parser.add_argument('--extract_mode', type=str, help='Data extraction mode')
    ...
    parser.add_argument('--correction_method', type=str, help='Batch correction method')
