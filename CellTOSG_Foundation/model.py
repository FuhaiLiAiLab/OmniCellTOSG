...
# custom modules
from CellTOSG_Foundation.loss import info_nce_loss, ce_loss, log_rank_loss, hinge_auc_loss, auc_loss
...
class CellTOSG_Foundation(nn.Module):
    ...
    def train_step(self, data, num_entity, name_embeddings, desc_embeddings, seq_embeddings, optimizer, alpha=0.002,
