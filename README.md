...
OmniCellTOSG is, to our knowledge, the first **cell-level Text–Omic dataset** and companion resources for **signaling-graph modeling** from single-cell data. It integrates quantitative omics with curated textual/semantic annotations to enable graph-based learning, retrieval, and explainable analysis across organs, tissues, cell types, and disease contexts.
